...
def simulate_deadtime(param, deadtime, freq=None, tseg=10.0, dt_hires=1e-5, dt=0.005, deadtime_type="const"):
    ...
    mean_cr = param[5] # mean count rate in the light curve
    ...
    mspec = two_lorentzian(freq, qpo1_amp, qpo1_fwhm, qpo2_amp, qpo2_x0, qpo2_fwhm)
...
def main():
    ...
    for i in range(num_iter):
        ...
        np.savetxt("grs1915_16s_15seg_noharmonic_theta%i.dat"%i, theta)
        np.savetxt("grs1915_16s_15seg_noharmonic_x%i.dat"%i, x)
